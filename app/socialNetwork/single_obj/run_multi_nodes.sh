...
ssh $SERVER1_NODE "sudo pkill -9 main"
ssh $SERVER2_NODE "sudo pkill -9 main"
ssh $SERVER1_NODE "mkdir -p $WORKPLACE/build/src"
ssh $SERVER2_NODE "mkdir -p $WORKPLACE/build/src"
scp $WORKPLACE/build/src/main $SERVER1_NODE:$WORKPLACE/build/src
scp $WORKPLACE/build/src/main $SERVER2_NODE:$WORKPLACE/build/src
mkdir -p logs
...
do
    ...
    sleep 5
    sudo build/src/main ../../../conf/controller CTL 18.18.1.3 &
    sleep 5
    sudo build/src/main ../../../conf/server1 SRV 18.18.1.3 &
    ssh $SERVER1_NODE "cd $WORKPLACE; sudo build/src/main ../../../conf/server2 SRV 18.18.1.3" &
    ssh $SERVER2_NODE "cd $WORKPLACE; sudo build/src/main ../../../conf/server3 SRV 18.18.1.3" &
    sleep 5
    sudo build/src/main ../../../conf/client1 CLT 18.18.1.3 &
    sleep 5
