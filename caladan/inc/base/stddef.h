...
#define check_types_match(expr1, expr2)         \
	((__typeof(expr1) *)0 != (__typeof(expr2) *)0)
...
#define container_of_var(member_ptr, container_var, member)             \
	container_of(member_ptr, __typeof(*container_var), member)
 ...
 */
#define swapvars(a, b) \
	do { __typeof(a) _t = (a); (a) = (b); (b) = _t; } while(0)
