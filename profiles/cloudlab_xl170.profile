...
portal.context.defineParameter("node_type", "Node Type", portal.ParameterType.STRING, "xl170")
portal.context.defineParameter("link_0_bw", "The bandwidth (GB/s) of link 0", portal.ParameterType.INTEGER, 10)
portal.context.defineParameter("link_1_bw", "The bandwidth (GB/s) of link 1", portal.ParameterType.INTEGER, 25)
